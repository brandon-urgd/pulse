...
export const labels = {
  ...
  revision: {
    ...
    overlayLongWait: 'This is taking longer than usual. Still working — please hang tight.',
    patience1: 'Reading your decisions and the original document.',
    patience2: 'Still rewriting. Longer documents take more time.',
    patience3: 'Almost done. Applying the final touches.',
  ...
  pulseCheck: {
    ...
    overlayLongWait: 'This is taking longer than usual. Still working — please hang tight.',
    patience1: 'Reading through all the sessions — this takes a moment.',
    patience2: 'Still synthesizing. Complex feedback takes time to consolidate.',
    patience3: 'Almost there. Finalizing the signal across all reviewers.',
    ...
    verdictPositive: 'Go',
    verdictNeutral: 'Fix first',
    verdictNegative: 'Retest',
